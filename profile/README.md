...
Most tools have alpha versions working on Unity LTS 6.3 and newer. The first full stable release is aimed for Unity 6.7. This is because we don't want to waste resources on maintaining the legacy changes made to the following Unity stuff.
...
In Unity 6.5 this was renamed to Physics Core 2D and is a built in module for Unity now.
...
All packages use the UXML attibute classes and no UxmlFactory/UxmlTraits classes. The UxmlFactory/UxmlTraits classes are being removed by Unity themselves in Unity 6.6 anyways. It was going to be Unity 6.4, but they pushed it back to 6.6.
